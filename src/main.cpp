...
=======
  if (OUT_RLY[in] < 10) {
    digitalWrite(OUT1, 1);
    digitalWrite(LA1, 1);
    tlc5620.writeTLC5620(DACA, DAC_REFX2, 0);
    delay(5);
  } else {
    digitalWrite(OUT1, 0);
    digitalWrite(LA1, 0);
  ...
  if (OUT_RLY[in + 1] < 10) {
    digitalWrite(OUT2, 1);
    digitalWrite(LA2, 1);
    tlc5620.writeTLC5620(DACB, DAC_REFX2, 0);
    delay(5);
  } else {
    digitalWrite(OUT2, 0);
    digitalWrite(LA2, 0);
  ...
  if (OUT_RLY[in + 2] < 10) {
    digitalWrite(OUT3, 1);
    digitalWrite(LA3, 1);
    tlc5620.writeTLC5620(DACC, DAC_REFX2, 0);
    delay(5);
  } else {
    digitalWrite(OUT3, 0);
    digitalWrite(LA3, 0);
  ...
  if (OUT_RLY[in + 3] < 10) {
    digitalWrite(OUT4, 1);
    digitalWrite(LA4, 1);
    tlc5620.writeTLC5620(DACD, DAC_REFX2, 0);
    delay(5);
  } else {
    digitalWrite(OUT4, 0);
    digitalWrite(LA4, 0);
...
>>>>>>> 350efd2 (tesst 0ke)
    ...
    //  #Setaddress^4^17*
    if (in == '#' && nhan == 0 ) nhan = 1;
    else if (in == 'S' && nhan == 1 ) nhan = 2;
    else if (in == 'e' && nhan == 2 ) nhan = 3;
    else if (in == 't' && nhan == 3 ) nhan = 4;
    else if (in == 'a' && nhan == 4 ) nhan = 5;
    else if (in == 'd' && nhan == 5 ) nhan = 6;
    else if (in == 'd' && nhan == 6 ) nhan = 7;
    else if (in == 'r' && nhan == 7 ) nhan = 8;
    else if (in == 'e' && nhan == 8 ) nhan = 9;
    else if (in == 's' && nhan == 9 ) nhan = 10;
    else if (in == 's' && nhan == 10 ) nhan = 11;
    else if (in == '^' && nhan == 11 ) nhan = 12;
    else
